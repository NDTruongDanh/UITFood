      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR1BanhCuonExtraLua,
              name: 'Thêm chả lụa',
              price: PRICE_TOPPING_MED,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR1BanhCuonExtraEgg,
              name: 'Trứng ốp la',
              price: PRICE_TOPPING_SMALL,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR1BanhCuonExtraCua,
              name: 'Chả cua',
              price: PRICE_TOPPING_PREMIUM,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            ...
            {
              optionId: IDS.optR1TraDaSugarLow,
              name: 'Ít đường',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR1TraDaSugarNorm,
              name: 'Bình thường',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR2BurgerSauceOrig,
              name: 'Bình thường',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR2BurgerSauceBbq,
              name: 'BBQ',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR2BurgerSauceMayo,
              name: 'Mayo',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR3ComTam1RiceS,
              name: 'Ít cơm',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3ComTam1RiceN,
              name: 'Bình thường',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3ComTam1RiceL,
              name: 'Nhiều cơm',
              price: PRICE_SIZE_UP,
              isDefault: false,
              isAvailable: true,
        ...
        },
        {
          ...
          options: [
            {
              optionId: IDS.optR3ComTam1SidePickle,
              name: 'Đồ chua',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3ComTam1SideEgg,
              name: 'Trứng ốp la',
              price: PRICE_TOPPING_SMALL,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3ComTam1SideBi,
              name: 'Thêm bì',
              price: PRICE_TOPPING_MED,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR3ComTam2SidePickle,
              name: 'Đồ chua',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3ComTam2SideEgg,
              name: 'Trứng ốp la',
              price: PRICE_TOPPING_SMALL,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3ComTam2SideBi,
              name: 'Thêm bì',
              price: PRICE_TOPPING_MED,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR3BanhMiSauceChili,
              name: 'Tương ớt',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3BanhMiSauceBlack,
              name: 'Tương đen',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3BanhMiSauceNone,
              name: 'Không sốt',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
        ...
        },
        {
          ...
          options: [
            {
              optionId: IDS.optR3BanhMiVegCuke,
              name: 'Dưa leo',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3BanhMiVegPickle,
              name: 'Đồ chua',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3BanhMiVegHerb,
              name: 'Rau mùi',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3BanhMiVegNone,
              name: 'Không rau',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            ...
            {
              optionId: IDS.optR3ComChayMushroom,
              name: 'Nấm xào',
              price: PRICE_MUSHROOM,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR3NuocNgotCola,
              name: 'Coca-Cola',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR3NuocNgotSprite,
              name: 'Sprite',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR4BbqMeatBaChi,
              name: 'Ba chỉ heo',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4BbqMeatCoHeo,
              name: 'Cổ heo',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4BbqMeatBoBaroi,
              name: 'Bò ba rọi',
              price: PRICE_BBQ_BEEF,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR4KimchiSpicy0,
              name: 'Không cay',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4KimchiSpicyM,
              name: 'Cay vừa',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4KimchiSpicyH,
              name: 'Cay nhiều',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR4BibimbapBeef,
              name: 'Thịt bò',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4BibimbapTofu,
              name: 'Đậu phụ',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR4TraSuaSugar0,
              name: '0% đường',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4TraSuaSugar30,
              name: '30% đường',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4TraSuaSugar50,
              name: '50% đường',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4TraSuaSugar100,
              name: '100% đường',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
        ...
        },
        {
          ...
          options: [
            ...
            {
              optionId: IDS.optR4TraSuaIceLow,
              name: 'Ít đá',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4TraSuaIceNorm,
              name: 'Bình thường',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
        ...
        },
        {
          ...
          options: [
            {
              optionId: IDS.optR4TraSuaToppingPearl,
              name: 'Trân châu đen',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4TraSuaToppingJelly,
              name: 'Thạch',
              price: PRICE_JELLY,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR4TraSuaToppingCream,
              name: 'Kem trứng',
              price: PRICE_CREAM,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR5SushiPortion8,
              name: '8 miếng',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5SushiPortion12,
              name: '12 miếng',
              price: PRICE_SUSHI_12,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5SushiPortion16,
              name: '16 miếng',
              price: PRICE_SUSHI_16,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR5SashimiPortion10,
              name: '10 lát',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5SashimiPortion15,
              name: '15 lát',
              price: PRICE_SASHIMI_15,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5SashimiPortion20,
              name: '20 lát',
              price: PRICE_SASHIMI_20,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR5BanhMiTempHot,
              name: 'Nóng',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5BanhMiTempCold,
              name: 'Lạnh',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
      ...
      modifiers: [
        {
          ...
          options: [
            {
              optionId: IDS.optR5TraXanhTempHot,
              name: 'Nóng',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5TraXanhTempCold,
              name: 'Lạnh',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
        ...
        },
        {
          ...
          options: [
            {
              optionId: IDS.optR5TraXanhStrengthLight,
              name: 'Nhạt',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5TraXanhStrengthNorm,
              name: 'Bình thường',
              price: PRICE_FREE,
              isDefault: true,
              isAvailable: true,
            ...
            {
              optionId: IDS.optR5TraXanhStrengthStrong,
              name: 'Đậm',
              price: PRICE_FREE,
              isDefault: false,
              isAvailable: true,
...
async function seedDeviceTokens() {
  ...
  console.log(
    '✅ device_tokens seeded (5 rows — 3 active, 1 inactive-recent, 1 stale-inactive)',
  );
}
