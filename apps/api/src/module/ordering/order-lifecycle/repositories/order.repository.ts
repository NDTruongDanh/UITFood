...
export class OrderRepository {
  ...
  /**
   * Load order detail for UI/API reads that need customer contact data.
   * The auth lookup stays behind USER_DIRECTORY_PORT so Ordering does not
   * depend on auth persistence tables.
   */
